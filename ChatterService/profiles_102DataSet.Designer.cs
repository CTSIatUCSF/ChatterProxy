...
namespace ChatterService.profiles_102DataSetTableAdapters {
...
SELECT PersonID, UserID, FirstName, LastName, MiddleName, DisplayName, Suffix, IsActive, EmailAddr, Phone, Fax, AddressLine1, AddressLine2, AddressLine3, AddressLine4, City, State, Zip, Building, Floor, Room, AddressString, Latitude, Longitude, GeoScore, FacultyRankID, InternalUsername, Visible FROM [Profile.Data].Person WHERE (PersonID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ChatterService.Properties.Settings.Default.profiles_102ConnectionString;
        }
